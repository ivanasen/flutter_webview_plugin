...
class SlidingDrawerWebviewScaffold extends StatefulWidget {
  const SlidingDrawerWebviewScaffold({
    Key key,
    this.appBar,
    @required this.url,
    this.headers,
  ...
  @override
  _SlidingDrawerWebviewScaffoldState createState() =>
      _SlidingDrawerWebviewScaffoldState();
}

class _SlidingDrawerWebviewScaffoldState
    extends State<SlidingDrawerWebviewScaffold> {
